...
def _render_claims_table(rows: list[SkillClaim] | list[Any], *, kind: str) -> list[str]:
    from jobfit.prep.claims.claims_layout import LayoutRow
...
def render_gaps_block(
    *,
    ...
    from jobfit.prep.claims.claims_merge import _GAPS_END, _GAPS_START
...
def render_claims_md(
    *,
    ...
    from jobfit.prep.claims.claims_layout import build_layout_sections
...
def run(
    *,
    ...
    from jobfit.prep.claims.claims_layout import build_layout_sections, load_layout
    from jobfit.prep.claims.claims_merge import (
        is_reviewed_claims,
        merge_gaps_block,
        parse_gaps_table,
    )
